Sub RestorePlatePositions()
    '　位置情報シートから配置位置を読み込んで、各プレートを再配置する
    ...
    For i = 2 To lastRow
        ...
        If positionData <> "" Then
            ...
            Call CreatePlate(plateWs, leftPos, topPos, 57, 22.8, lastName, firstName, "atd" & employeeCode, RGB(255, 0, 0))
        End If
        ...
        If positionData <> "" Then
            leftPos = Split(positionData, ",")(0)
            topPos = Split(positionData, ",")(1)
            Call CreatePlate(plateWs, leftPos, topPos, 57, 22.8, lastName, firstName, "ovt" & employeeCode, RGB(0, 204, 255))
        End If
    Next i
...
Sub CreatePlate(ws As Worksheet, x As Single, y As Single, width As Single, height As Single, lastName As String, firstName As String, shapeName As String, fillColor As Long)
    Dim shp As Shape
